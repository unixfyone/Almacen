					...
					<div class="card card-<?= $cstyle; ?> elevation-2">
						...
						<div class="card-body">
							...
							<div class="panel-body">
								...
								<br><br>
								<?php
								$SQL_A = "SELECT *, wh_materials.id AS matid, wh_type_material2.name AS nametm2, 
								FROM wh_materials 
								...
								$SQL = "SELECT mat.*, mat.id as matid, mat.company_id, cia.id, cia.company, mat.zone_id, tm2.name, tm2.id, concat(mat.company_id, mat.type_tm2_id) as idtm2
								FROM wh.wh_materials mat
								inner join companies cia on cia.id = mat.company_id
								...
								$mValore1X = '';
								$mValors1X= '';
								$mt2X = $FilaX2["type_tm2_id"];
								$prodid2X = $FilaX2["matid"];
								$cia2X = $FilaX2["company_id"];
								
								$query = "SELECT * FROM wh_saldosm sal
								left join wh_materials mat2 on mat2.id = sal.product_id
								left join wh_type_material2 on wh_type_material2.id = mat2.type_tm2_id
								WHERE sal.company_id = '$cia2X' and sal.aa_s = '$AA' and mat2.type_tm2_id = '$mt2X'
								";	
									...
									//=======================================================
										...
										$totale1X = $existencia1X * $row1X["cost_me"];
										$totale1XG = $totale1XG + ($existencia1X * $row1X["cost_me"]);
									}	
								...
								//=======================================================		
										...
										?>								
										<Tr height= '16px'>
										<Td><font size="2px"><?php echo $FilaX2['company_id']; ?></font></td>
										<Td><font size="2px"><?php echo $FilaX2['company']; ?></font></td>
										<Td><font size="2px"><?php echo $FilaX2['zone_id']; ?></font></td>
										<Td><span class="text-wrap"><font size="2px"><?php echo $FilaX2['name']; ?></font></span></td>
										<Td><font size="2px"><?php echo $FilaX2['id'];?></font></td>
										<Td><font size="2px"><?php echo $FilaX2['idtm2'];?></font></td>
										<Td><font size="2px"><?php echo $totale1XG;?></font></td>
										</tr>
									<?php
										//}
