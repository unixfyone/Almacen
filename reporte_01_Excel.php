...
//---------------------------------------------------------------
$stmt = $connect->prepare("SELECT * FROM wh_materials 
...
and wh_materials.wh_line_id_m = '$LIN' and wh_materials.m_statu_m = 'Activo' 
...
$sheet->setCellValue('B1', 'UBICACION DE MATERIALES POR LINEA');
...
header('Content-Disposition: attachment;filename="Ubicaciones_Materiales_' . date('Ymd') . '.xlsx"');
