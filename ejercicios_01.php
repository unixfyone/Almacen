...
<div class="content-wrapper">
    <section class="content-header">
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-6">
					<h1 class="m-0"><b><font color="#<?=$ccolor;?>" FACE="times new roman" size="5px">Ejercicios
					</font></b></h1>
				</div>
			</div>
		</div><!-- /.container-fluid -->
				...
				<div class="col-12">
					<div class="card card-<?= $cstyle; ?> elevation-2">
						<div class="card-header elevation-1" style="background-color:#<?=$ccolor;?>">
							<b><font color="#FFFFFF" FACE="times new roman" size="4px">Control de Ejercicios</font></b>
						</div>
						<!-- /.card-header -->
						<div class="card-body">
							...
							<div align="center">
								...
								<th class="thx"><p> Año / Ejercicio </p></th>
								...
								$contador++;
								echo "<tr>";
								echo "<td bgcolor='#EEEEEE' align=Center><p>  $contador </P></td>";
								...
								echo "<td bgcolor='#EEEEEE' Align=Center><font size=2>" . $Fila['ej_aa'];
								if ($Fila['ej_statu'] == "Cerrado")
								{
								...
								<br>
								<div align="center">
									<button class="btn btn-outline-<?php echo $classButtonFooter; ?>" Type="Submit" name="BotonADD"><i class="fa fa-plus"></i> Activar Ejercicio</button>
								</div>
								<br><br>
								</form>
							</div>
