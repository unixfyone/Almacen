...
$ciarec = $Fila1["cia_receptor_d"];
$dptrec = $Fila1["dep_receptor_d"];
$usrrec = $Fila1["user_receptor_d"];
$dptdes = $Fila1["dep_despachador_d"];
$usrdes = $Fila1["user_despachador_d"];
$dptapr = $Fila1["dep_aprobador_d"];
$usrapr = $Fila1["user_aprobador_d"];
} 
}
											...
											<div class="row">
												<div class="col-lg-4">
													<div class="form-group">
														...
														<?php
														//------------------------------------
														$SQL="Select * FROM companies WHERE id = '$ciarec' ";
														...
														//--------------------------------------
														?>									
														<Input class="form-control" Type="Text" name="ciarec" value="<?Php echo $ciadesc ?>" readonly />
													</div>
												</div>
												...
												<div class="col-lg-4">
													<div class="form-group">
														...
														<?PHP
														//---------------------------------------------------------------
														$query = "SELECT * FROM departments WHERE id = '$dptrec' ";
														...
														while ($row=mysqli_fetch_array($Registro))
															{
															$dptrec_id= $row["id"];
															$dptrec_name= $row["department"];
															}														
														mysqli_free_result ($Registro);
														//---------------------------------------------------------------
														?>
														<Input class="form-control" Type="Text" name="dptrec" value="<?Php echo $dptrec_name ?>" readonly />
													</div>
												</div>
												<div class="col-lg-4">
													<div class="form-group">
														<label class="input-group-text"><font color="#606060" size="3px"> Usuario Receptor.:</font></label>
														<?PHP
														//---------------------------------------------------------------
														$query = "SELECT * FROM users where id = '$usrrec' ";
														...
														while ($row=mysqli_fetch_array($Registro))
															{
															$usrrec_id= $row["id"];
															$usrrec_name= $row["first_name"].' '. $row["last_name"];
															}
														mysqli_free_result ($Registro);
														//---------------------------------------------------------------
														?>
														<Input class="form-control" Type="Text" name="usrrec" 
														value ="<?Php echo $usrrec_name ?>" readonly />
													</div>
												</div>
											</div>	
											...
											<div class="row">
												<div class="col-lg-6">
													<div class="input-group">
														...
														//$depaprobd= '';
														//---------------------------------------------------------------
														$query = "SELECT * FROM departments WHERE id = '$dptapr' ";
														...
														while ($row=mysqli_fetch_array($Registro))
															{
															$dptapr_id= $row["id"];
															$dptapr_name= $row["department"];
															}														
														mysqli_free_result ($Registro);
														//---------------------------------------------------------------
														?>
														<Input class="form-control" Type="Text" name="dptapr" 
														value="<?Php echo $dptapr_name ?>" readonly />
													</div>
												</div>
												<div class="col-lg-6">
													<div class="input-group">
														...
														<?PHP
														//---------------------------------------------------------------
														$query = "SELECT * FROM users where id = '$usrapr' ";
														...
														while ($row=mysqli_fetch_array($Registro))
															{
															$usrapr_id= $row["id"];
															$usrapr_name= $row["first_name"].' '. $row["last_name"];
															}
														mysqli_free_result ($Registro);
														//---------------------------------------------------------------
														?>
														<Input class="form-control" Type="Text" name="user_aprobador" 
														value ="<?Php echo $usrapr_name ?>" readonly />
													</div>
												</div>									
											</div>
											...
											<div class="row">
												<div class="col-lg-6">
													<div class="input-group">
														...
														<?PHP
														//---------------------------------------------------------------
														$query = "SELECT * FROM departments WHERE id = '$dptdes' ";
														...
														while ($row=mysqli_fetch_array($Registro))
															{
															$dptdes_id= $row["id"];
															$dptdes_name= $row["department"];
															}														
														mysqli_free_result ($Registro);
														//---------------------------------------------------------------
														?>
														<Input class="form-control" Type="Text" name="dptdes" 
														value ="<?Php echo $dptdes_name ?>" readonly />
													</div>											
												</div>
												<div class="col-lg-6">
													<div class="input-group">
														...
														<?PHP
														//---------------------------------------------------------------
														$query = "SELECT * FROM users where id = '$usrdes' ";
														...
														while ($row=mysqli_fetch_array($Registro))
															{
															$usrdes_id= $row["id"];
															$usrdes_name= $row["first_name"].' '. $row["last_name"];
															}
														mysqli_free_result ($Registro);
														//---------------------------------------------------------------
														?>
														<Input class="form-control" Type="Text" name="usrdes" 
														value ="<?Php echo $usrdes_name ?>" readonly />
													</div>
												</div>									
											</div>
											<!-- ==================================================== -->
