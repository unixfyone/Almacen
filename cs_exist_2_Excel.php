...
$NOM1 = "Existencia_Materiales-Categorias";
$NOM2 = ".xls";
...
<HTML>
<HEAD>
<TITLE>EXISTENCIA DE MATERIALES POR CATEGORIA</TITLE>
...
Where wh_materials.zone_id = '$ZON' and wh_materials.company_id = '$CIA' and wh_materials.wh_category_id_m = '$CAT' and wh_materials.m_statu_m = 'Activo' and wh_saldosm.aa_s = '$AA'
Order by wh_materials.code ASC";
//---------------------------------------------------------------
//----------
echo "<font color='#660000' size='5'><b>EXISTENCIA DE MATERIALES POR CATEGORIA</b></font>";
echo "<br>";
echo "<font color='blue' size='4'><b>$DCIA</b></font>";
echo "<br>";
echo "<font color='#990000' size='4px'><b>$ZOND</b></font>";
echo "<br>";
