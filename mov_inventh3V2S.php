...
//else $mdtipent = '';
//-------------
if(isset($_GET["ciarec"]))$ciarec = $_GET["ciarec"];
else $ciarec = '';
//-------------
if(isset($_GET["dptrec"]))$dptrec = $_GET["dptrec"];
else $dptrec = '';
//-------------
if(isset($_GET["usrrec"]))$usrrec = $_GET["usrrec"];
else $usrrec = '';
//-------------
if(isset($_GET["dptdes"]))$dptdes = $_GET["dptdes"];
else $dptdes = '';
//-------------
if(isset($_GET["usrdes"]))$usrdes = $_GET["usrdes"];
else $usrdes = '';
//-------------
if(isset($_GET["dptapr"]))$dptapr = $_GET["dptapr"];
else $dptapr = '';
//-------------
if(isset($_GET["usrapr"]))$usrapr = $_GET["usrapr"];
else $usrapr = '';
//-------------
...
$receptor_e = $Fila["movh_receptor_e"];
if($CT1 == '0') {
$ciarec = $Fila["cia_receptor_es"];
$dptrec = $Fila["dep_receptor_es"];
$usrrec = $Fila["user_receptor_es"];
$dptdes = $Fila["dep_despachador"];
$usrdes = $Fila["user_despachador"];
$dptapr = $Fila["dep_aprobador"];
$usrapr = $Fila["user_aprobador"];
}
$ORCO = $Fila["movh_oc"];
...
<Input Type="hidden" name="ciarec" value="<?Php echo $ciarec ?>">
<Input Type="hidden" name="dptrec" value="<?Php echo $dptrec ?>">
<Input Type="hidden" name="usrrec" value="<?Php echo $usrrec ?>">
<Input Type="hidden" name="dptdes" value="<?Php echo $dptdes ?>">
<Input Type="hidden" name="usrdes" value="<?Php echo $usrdes ?>">
...
<!-- ====================================================== -->
								<?php if ($receptor_e != '') {  ?>
								<div id="content2" style="display: none;" class="col-sm-12">
									<div class="row">
										<div class="col-lg-4">
											<div class="input-group">
								...
								<div class="row">
									<div class="col-lg-6">
										<div class="input-group">
											...
											//-------
											echo '<option ';
											if($dptdes == $row["id"])echo 'selected ';
											echo 'value=' . $row["id"] .'>'. $row["department"] . "\n";
											}
											mysqli_free_result ($Registro);
											//---------------------------------------------------------------
									...
									<div class="col-lg-6">
										<div class="input-group">
											...
											inner join departments on departments.id = positions.department_id
											inner join users on users.position_id = positions.id
											where departments.statu = 'Activo' and positions.department_id = '".$dptdes."'
											";
											...
											//-------
											echo '<option ';
											if($usrdes == $row["id"])echo 'selected ';
											echo 'value=' . $row["id"] .'>'.$row["first_name"].' '.$row["last_name"]. "\n";
											}
											mysqli_free_result ($Registro);
											//---------------------------------------------------------------
								...
								<div class="row">
									<div class="col-lg-6">
										<div class="input-group">
											...
											//-------
											echo '<option ';
											if($dptapr == $row["id"])echo 'selected ';
											echo 'value=' . $row["id"] .'>'. $row["department"] . "\n";
											}
											mysqli_free_result ($Registro);
											//---------------------------------------------------------------
									...
									<div class="col-lg-6">
										<div class="input-group">
											...
											inner join departments on departments.id = positions.department_id
											inner join users on users.position_id = positions.id
											where departments.statu = 'Activo' and positions.department_id = '".$dptapr."'
											";
											...
											//-------
											echo '<option ';
											if($usrapr == $row["id"])echo 'selected ';
											echo 'value=' . $row["id"] .'>'.$row["first_name"].' '.$row["last_name"]. "\n";
											}
											mysqli_free_result ($Registro);
											//---------------------------------------------------------------
