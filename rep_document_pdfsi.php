...
<div class="content-wrapper">
    <section class="content-header">
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-6">
					<h1 class="m-0"><b><font color="#<?=$ccolor;?>" size="5px">Movimiento Almacen
					</font></b></h1>
				</div>
				<div class="col-sm-6" align='right'>
					...
					<a class="btn btn-outline-<?php echo $classButtonHeader;?>" href="<?php echo "rep_document4_pdf.php?IDM=$IDM&MOP=$MOP "; ?>" target="_blank"><i class='fa fa-print'></i> Imprimir Documento</a>
				...
				<div class="col-12">
					<div class="card card-<?= $cstyle; ?> elevation-2">
						<div class="card-header elevation-1" style="background-color:#<?=$ccolor;?>">
							<b><font color="#FFFFFF" size="4px">Documento Movimientos de Materiales</font></b>
						</div>
						...
						<div class="card-body">
							<div class="panel-body">
								<div class="form-group">
									<label><font color="#660000" size="2px">Almacen..:  </font></label>
									&nbsp;&nbsp;<label><font color="black" size="3px"> <?Php echo $ZOND ."&nbsp;&nbsp; / &nbsp;&nbsp;". $ZONU; ?></font></label>
									<br>
								</div>
								<!-- =========================== -->
...
//================================================	
	...
	{
		$status = '<span class=""><font color="green" size="2px">Abierto</font></span>';	
	}	else	{
		$status = '<span class=""><font color="red" size="2px">Cerrado</font></span>';	
	}
//================================================			
								?>
								<Tr height= '16px'>
									...
									<Td align="right"><font size="2px"><?php echo number_format($Fila['movd_cant'], 2, ",", ".");?></font></td>
									<Td align="right"><font size="2px"><?php echo number_format($Fila['movd_costou_me'], 3, ",", ".");?>
