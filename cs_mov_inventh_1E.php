								...
								<div class="row">
									<div class="col-sm-6">
										<div class="form-group">
											...
											<div class="input-group-prepend">
												<input type="text" name="movh_proce" id="movh_proce" maxlength="60" class="form-control" placeholder="Procedencia / Proveedor / Cliente" value="<?Php echo $MPROC ?>" readonly />
											</div>
										</div>
									</div>
									...
									<div class="col-sm-6">
										<div class="form-group">
											...
											<select name="PROVE" class="form-control" disabled />
											<?PHP
											//---------------------------------------------------------------
								...
								<div class="row">
									<div class="col-lg-6">
										<div class="input-group">
											<label class="input-group-text"><font color="#505050" size="3px">Departamento Receptor.:</font></label>
