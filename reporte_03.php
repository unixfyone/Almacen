...
<div class="content-wrapper">
    ...
    <section class="content-header">
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-6">
					<h1 class="m-0"><b><font color="#<?=$ccolor;?>" FACE="times new roman" size="5px">Consumos por Líneas</font></b></h1>
				</div>
			</div>
		</div><!-- /.container-fluid -->
    </section>
				...
				<div class="col-12">
					<div class="card card-<?= $cstyle; ?> elevation-2">
						<div class="card-header elevation-1" style="background-color:#<?=$ccolor;?>">
							<b><font color="#FFFFFF" FACE="times new roman" size="4px">Consumos por Líneas/Periodos</font></b>
						</div>
						<!-- /.card-header -->
						<div class="card-body">
	...
	<!-- ========================================================== -->
	<?php if ($CIA != '' and $ZON != '' and $LIN != '' and $AA != '' and $MM != '') { ?>
					...
					<div class="card card-<?= $cstyle; ?> elevation-2">
						<div class="card card-<?= $cstyle; ?>-dark card-outline">
							<div class="card-header bg-light border-0">
								<h5 class="card-title text-<?= $cstyle; ?>-dark text-bold">Consumos </h5>
							</div>
						</div>

					<!-- *********************************** -->	
						<div class="container-fluid">
							<a class="btn btn-outline-<?php echo $classButtonHeader;?> btn-xs elevation-1" href="<?php echo "reporte_03_pdf.php?CIA=$CIA&ZON=$ZON&AA=$AA&MM=$MM&LIN=$LIN "; ?> " target="_blank">  Imprimir en PDF</a>
							<br><br>
						
							<?php
							//---------------------------------------------------------------
							$SQL = "SELECT movd.*, mat.*, um.name AS umname, li.namel
							...
							while($Fila = mysqli_fetch_array($Registro2))
							{
								...
								//=============================
								echo "<tr>";
								echo "<td align=Center><font size=2>" . $Fila['movd_fecha'];
								echo "<td align=Center><font size=2>" . $Fila['movh_doc'];								
