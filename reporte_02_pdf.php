...
{	
	...
	$this->Cell(100,5,utf8_decode('EXISTENCIAS DE MATERIALES'),1,1,'C');
	...
	$this->Cell(160,6,utf8_decode ($GLOBALS['DZON']),1,0,'L');
	...
	$this->SetFont('Arial','',11);
	$this->Cell(160,6,utf8_decode ($GLOBALS['DLIN']),1,0,'L');
	...
	$this->SetFont('Arial','B',10);
	$this->Cell(18,6,utf8_decode('CODIGO'),1,0,'C',1);
	$this->Cell(130,6,'DESCRIPCION',1,0,'C',1);
	$this->Cell(32,6,'UBICACION',1,0,'C',1);
	$this->Cell(25,6,'EXISTENCIA',1,1,'C',1);	
...
//---------------------------------------------------------------
	...
	//---------------
			...
			{ 
				...
				$pdf->Cell(18,5,utf8_decode($Fila3['code']),1,0,'C');
				$pdf->SetFont('Arial','',8);
				$pdf->Cell(130,5,utf8_decode($Fila3['description_m']),1,0,'L');
				$pdf->Cell(32,5,utf8_decode($Fila3['ubication']),1,0,'C');
				$pdf->Cell(25,5,utf8_decode($Fila3['Stock']),1,1,'C');
