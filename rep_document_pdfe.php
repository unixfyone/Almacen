		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-6" align='right'>
					...
					<a class="btn btn-outline-<?php echo $classButtonHeader;?>" href="<?php echo "rep_document2_pdf.php?IDM=$IDM&MOP=$MOP "; ?>" target="_blank"><i class='fa fa-print'></i> Imprimir Documento</a>
