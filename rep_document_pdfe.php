		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-6" align='right'>
					...
					<a type='button' class='btn btn-outline-<?php echo $classButtonHeader; ?> btn-xs elevation-1' href=\"rep_document2_pdf.php?IDM=$IDM \"><i class='fa fa-print'></i> Imprimir Documento</a>
