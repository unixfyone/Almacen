...
//$mdcostoul = $Fila1["movd_costou_ml"];	// Costo Unitario Producto
			...
			<div class="container-fluid">
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-lg-8">
							<div class="input-group">
								...
								<Input class="form-control" Type="Text" name="dmov" size="80" value="<?Php echo $dmov ?>" readonly>
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-lg-5">
							<div class="input-group">
								<span class="input-group-text"><font color="#660000" FACE="times new roman" size="3px">Costo Unitario ME.:</font></span>
